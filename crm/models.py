...
class Customer(models.Model):
    ...
    referral_from = models.ForeignKey('self',on_delete=models.CASCADE,verbose_name=u"转介绍自学员",help_text=u"若此客户是转介绍自内部学员,请在此处选择内部＼学员姓名",blank=True,null=True,related_name="internal_referral")
    #已开设的课程单独搞了张表，客户想咨询哪个课程，直接在这里关联就可以
    course = models.ForeignKey("Course",on_delete=models.CASCADE,verbose_name=u"咨询课程")
    ...
    consultant = models.ForeignKey("UserProfile",on_delete=models.CASCADE,verbose_name=u"课程顾问")
...
class Enrollment(models.Model):
    ...
    school = models.ForeignKey('Branch',on_delete=models.CASCADE, verbose_name='校区')

    #选择他报的班级，班级是关联课程的，比如python开发10期
    course_grade = models.ForeignKey("ClassList",on_delete=models.CASCADE, verbose_name="所报班级")
...
class CustomerFollowUp(models.Model):
    '''存储客户的后续跟进信息'''
    customer = models.ForeignKey(Customer,on_delete=models.CASCADE,verbose_name=u"所咨询客户")
    ...
    consultant = models.ForeignKey("UserProfile",on_delete=models.CASCADE,verbose_name=u"跟踪人")
...
class CourseRecord(models.Model):
    ...
    #讲师创建上课纪录时要选择是上哪个班的课
    course = models.ForeignKey(ClassList,on_delete=models.CASCADE, verbose_name="班级(课程)")
...
class StudyRecord(models.Model):
    '''存储所有学员的详细的学习成绩情况'''
    student = models.ForeignKey("Customer",on_delete=models.CASCADE,verbose_name=u"学员")
    course_record = models.ForeignKey(CourseRecord,on_delete=models.CASCADE, verbose_name=u"第几天课程")
...
class UserProfile(auth.AbstractBaseUser, auth.PermissionsMixin):
    ...
    branch = models.ForeignKey("Branch",on_delete=models.CASCADE,verbose_name="所属校区",blank=True,null=True)
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(UserProfile,on_delete=models.CASCADE, verbose_name="负责老师", help_text="谁签的单就选谁")
