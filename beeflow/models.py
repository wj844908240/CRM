...
class Flow(models.Model):
    ...
    started_user = models.ForeignKey(crm_models.UserProfile,on_delete=models.CASCADE,verbose_name="流程发起人")
...
class Step(models.Model):
    """流程的每个环节"""
    flow_template = models.ForeignKey("FlowTemplate",on_delete=models.CASCADE,verbose_name="所属流程")
